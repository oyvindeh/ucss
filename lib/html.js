...
module.exports = {
    ...
    _processHtmlString: function(html, followLinks, currentUri, selectors, whitelist, cookie, result, processed, queue, queueCallback) {
        ...
        if (followLinks) { // look for links in document, add to queue
            ...
            if (links.length) {
                for (var i=0, l=links.length; i<l; i++) {
                    this._handleLink(links[i], processed, currentUri, followLinks, queue, cookie);
                }
            }
        }
