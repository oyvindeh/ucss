...
var ucss = {
    ...
    _extractSelectorsFromString: function(css, selectors) {
        ...
        // TODO: return _shake(rules, selectors)
        // !TODO: Move out, so it's not a closure (needs selectors object)
...
//                      TODO: replace ^ selectors[s] = (selectors[s] || 0) + 1;
                    }
                }
            }
            return selectors;
    ...
    _matchSelectorsInHtml: function(self, pages, cookie, selectors,
        ...
        if (pages.exclude) {
            for (var i=0, l=pages.exclude.length; i<l; i++) {
        ...
        if (pages.crawl) {
            for (var i=0, l=pages.crawl.length; i<l; i++) {
        ...
        if (pages.include) {
            for (var i=0, l=pages.include.length; i<l; i++) {
