...
// TODO: Fix this
var root = "http://127.0.0.1:9988/";

        self._collectCssSelectors(css, function(selectors, result) {
            self._processHtml(self, root, html, cookie, selectors,
     ...
     */
    _processHtml: function(self, root, html, cookie, selectors,
                           whitelist, result, donecb) {
        ...
        var processingFunc = function(item, callback) {
            ...
            var doProcessing = function(html) {
                $ = cheerio.load(html);
