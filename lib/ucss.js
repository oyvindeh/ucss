...
var ucss = {
    ...
    search: function(context, donecb) {
        ...
        self._collectCssSelectors(css, function(selectors, result) {
            self._processHtml(self, domain, html, cookie, selectors,
     ...
     */
    _processHtml: function(self, domain, html, cookie, selectors,
                           whitelist, result, donecb) {
        ...
        var processingFunc = function(item, callback) {
            ...
            var doProcessing = function(html, currentUri) {
        ...
        var q = async.queue(processingFunc, 8);
        q.push(items);
