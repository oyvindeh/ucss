...
var ucss = {
    ...
    _read_file_http: function(file_url, ctx){
        ...
        ,   file      = fs.createWriteStream(__dirname+'/'+file_name);
...
// TODO multiple remote files are not working as expected, total number of rules varies (randomly?)   
            ...
            if(isAsyncFinished){
				...
				// rules are given by command line parameter => no rules collected so far.
    ...
    _asyncContext:{
        processed: 0, // nr of currently processed css resources
