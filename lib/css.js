        ...
        async.forEach(css, function(item, forEachCallback) {
            ...
            if (err) {
                ...
                for (var selector in selectors) {
                    ...
                    if (selectors[selector] && selectors[selector].count > 1) {
                        duplicates[selector] = selectors[selector].count;
                    }
                    if (selectors[selector] && selectors[selector].pos) {
                        pos[selector] = selectors[selector].pos;
                    }
                }
